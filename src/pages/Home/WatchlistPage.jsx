...
function WatchlistPage() {
  ...
  // Trigger AuthModal via the custom event listener in ParentComponent
  ...
  return (
    ...
    >
      <SEO title="My Watchlist - NowzyFlix" description="View your saved movies and TV shows." />
      ...
      <div className="sticky top-0 z-40 -mx-4 sm:-mx-8 px-4 sm:px-8 pt-[calc(env(safe-area-inset-top)+0.75rem)] md:pt-0 pb-3 md:pb-0 backdrop-blur-md bg-black/80 md:bg-transparent border-b border-white/[0.06] md:border-none mb-4 md:mb-0">
        <div className="flex items-center gap-3 md:hidden">
          <span className="w-1.5 h-8 bg-cyan-600 rounded-full inline-block shadow-[0_0_10px_rgba(8,145,178,0.5)]" />
        ...
        <div className="flex items-center justify-center min-h-[60vh]">
          ...
          >
            <div className="flex justify-center mb-8">
              <div className="relative">
                <div className="w-16 h-16 rounded-2xl bg-cyan-600/10 border border-cyan-500/20 flex items-center justify-center">
                  <FaBookmark className="text-cyan-500 text-xl" />
                </div>
                <span className="absolute -top-1 -right-1 w-3.5 h-3.5 rounded-full bg-cyan-600 border-2 border-black" />
              </div>
            </div>
            ...
            <button
              ...
              className="inline-flex items-center gap-2 bg-cyan-600 hover:bg-cyan-500 text-white font-semibold px-6 py-2.5 rounded-lg text-sm transition-colors shadow-lg shadow-cyan-600/20"
            >
              Sign in
            </button>
          </motion.div>
        ...
        <div className="flex items-center justify-center min-h-[60vh]">
          ...
          >
            <div className="flex items-center gap-4 mb-10">
              <div className="flex-1 h-px bg-gradient-to-r from-transparent to-cyan-600/30" />
              <FaBookmark className="text-cyan-600/60 text-[10px]" />
              <div className="flex-1 h-px bg-gradient-to-l from-transparent to-cyan-600/30" />
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <button
                ...
                className="group flex items-center justify-center gap-2.5 bg-cyan-600 hover:bg-cyan-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors duration-200 text-sm shadow-lg shadow-cyan-600/20"
              >
              ...
              <button
                ...
                className="group flex items-center justify-center gap-2.5 border border-white/10 hover:border-cyan-500/30 bg-white/[0.03] hover:bg-cyan-500/5 text-gray-300 hover:text-white font-medium px-6 py-3 rounded-lg transition-all duration-200 text-sm"
              >
                <BiTv className="text-base text-gray-400 group-hover:text-cyan-400 transition-colors" />
                TV Shows
              </button>
            </div>
            <div className="mt-10 h-px bg-gradient-to-r from-transparent via-cyan-600/20 to-transparent" />
          </motion.div>
        </div>
      )}
